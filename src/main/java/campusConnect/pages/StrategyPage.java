...
public class StrategyPage {
	...
	@FindBy(xpath="//a[normalize-space()='Mprod_strategy one']")
	...
	@FindBy(xpath="//h5[normalize-space()='Mprod_strategy one']")
	private WebElement strategyAddToCartSuccessHeading;
	...
	public void strategyAddToCartProduct() throws InterruptedException {
		strategyBtn.click();
		Thread.sleep(2000);
	...
	public String retriveAddToCartSuccessMessage() {
		...
		String addToCartSuccessfullyHeadingText = strategyAddToCartSuccessHeading.getText();
