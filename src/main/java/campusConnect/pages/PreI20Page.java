...
public class PreI20Page {
	...
	@FindBy(xpath="//a[normalize-space()='Mprod_prei20']")
	...
	@FindBy(xpath="//h5[normalize-space()='Mprod_prei20']")
	private WebElement preI20AddToCartSuccessHeading;
	
	
	public PreI20Page(WebDriver driver) {    
        this.driver = driver;
        PageFactory.initElements(driver, this);    
    }
	
	public void preI20AddToCartProduct() throws InterruptedException {
		preI20Btn.click();
		Thread.sleep(2000);
	...
	public String retriveAddToCartSuccessMessage() {
		...
		String addToCartSuccessfullyHeadingText = preI20AddToCartSuccessHeading.getText();
